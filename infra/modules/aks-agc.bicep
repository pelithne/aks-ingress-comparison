...
// ============================================================================
// Deploys an AKS cluster configured for use with Application Gateway for 
// Containers (AGC). Uses Azure CNI Powered by Cilium for networking.
// ============================================================================
...
resource aksCluster 'Microsoft.ContainerService/managedClusters@2024-09-02-preview' = {
  ...
  properties: {
    ...
    // Network profile - Azure CNI Powered by Cilium
    networkProfile: {
      networkPlugin: 'azure'
    ...
    // OIDC issuer for workload identity (required for AGC ALB Controller)
    oidcIssuerProfile: {
      enabled: true
    }
...
output identityResourceId string = aksIdentity.id
